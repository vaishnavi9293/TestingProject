...
public class loginpostfbwithjavaexecutorinterface {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//js.executeScript("document.getElementByXpath('//div[@class='_1mwp navigationFocus _395 _1mwq _4c_p _5bu_ _34nd _21mu _5yk1']').value='hi all';");
        js.executeScript("document.getElementByXpath('(//div[@role=\'presentation\'])[3]').value='hello';)");
